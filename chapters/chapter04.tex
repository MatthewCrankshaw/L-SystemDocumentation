...
The \acrshort{bnf} of the L-system has the goal state of $<$lSystem$>$, in terms of the L-system grammar it is made up of a collection of statements begining with the symbol \say{\#} and ending with the symbol \say{;}. The non terminal symbols $<$float$>$ and $<$variable$>$ specify a regular expression.
